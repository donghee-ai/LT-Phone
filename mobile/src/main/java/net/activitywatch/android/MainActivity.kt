...
import net.activitywatch.android.push.LTPushSettingsActivity
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener, WebUIFragment.OnFragmentInteractionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // LT: 툴바를 액션바로 세우고 햄버거(서랍 토글)를 붙인다.
        // 이게 없으면 서랍이 가장자리 스와이프로만 열려 사실상 발견되지 않는다.
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_lt_push_settings -> {
                startActivity(Intent(this, LTPushSettingsActivity::class.java))
            }
            R.id.nav_share -> {
